...
def test_get_activities_authenticated():
    ...
    unique_id = str(uuid.uuid4())[:8]
    user_data = {
        "email": f"activities_test_{unique_id}@example.com",
        "username": f"acttest_{unique_id}",
        "full_name": "Activities Test User",
        "password": "test123"
    }
...
def test_get_activity_by_id():
    ...
    unique_id = str(uuid.uuid4())[:8]
    user_data = {
        "email": f"byid_test_{unique_id}@example.com",
        "username": f"byidtest_{unique_id}",
        "full_name": "By ID Test User",
        "password": "test123"
    }

...
export const useSummaryStats = ({ stats, viewMode, onViewChange }: UseSummaryStatsProps): UseSummaryStatsResult => {
    const statItems: StatItem[] = [
        { value: `${stats.Distance}KM`, label: 'Distance', mode: 'list' as ViewMode },
        { value: stats.Days, label: 'Days', mode: 'calendar' as ViewMode },
        { value: stats.AvgPace, label: 'AvgPace', mode: 'chart' as ViewMode },
